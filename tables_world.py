...
dataDictionary = {"World": {}}
dataDictionary["World"]["country"] = "World"

dataDictionary["World"]["table1"] = [
    [
...
for country_name in country_names:
    dataDictionary[country_name] = copy.deepcopy(dataDictionary["World"])
